...
{global $db,$menu;
    ...
    $blog = $db->query("select * from blog where Id=$menu[3]")->fetch();
    ?>
        ...
        <main class="tm-main">
            <div class="row tm-row">
                <div class="col-12">
                    ...
                    <img src="wwwroot/BlogResim/<?=$blog['ImageName']?>" width="954" height="535" controls class="tm-mb-40"/>
                </div>
            </div>
            <div class="row tm-row">
                <div class="col-lg-8 tm-post-col">
                    <div class="tm-post-full">
                        <div class="mb-4">
                            <h2 class="pt-2 tm-color-primary tm-post-title"><?=$blog["Name"]?></h2>
                            <p class="tm-mb-40"><?=$blog["CreateDate"]?>,  samet yorgun tarafından</p>
                            <p>
                                <?=$blog["Description"]?>
                            </p>
                ...
                <aside class="col-lg-4 tm-aside-col">
                    <div class="tm-post-sidebar">
                        ...
                        <a href="#" class="d-block tm-mb-40">
                            <figure>
                                <img src="wwwroot/blogtema/img/img-02.jpg" alt="Image" class="mb-3 img-fluid">
                                <figcaption class="tm-color-primary">Duis mollis diam nec ex viverra scelerisque a sit</figcaption>
                            </figure>
                        </a>
                        <a href="#" class="d-block tm-mb-40">
                            <figure>
                                <img src="wwwroot/blogtema/img/img-05.jpg" alt="Image" class="mb-3 img-fluid">
                                <figcaption class="tm-color-primary">Integer quis lectus eget justo ullamcorper ullamcorper</figcaption>
                            </figure>
                        </a>
                        <a href="#" class="d-block tm-mb-40">
                            <figure>
                                <img src="wwwroot/blogtema/img/img-06.jpg" alt="Image" class="mb-3 img-fluid">
